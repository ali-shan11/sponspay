...
import { CompensationAddedDialogComponent } from './compensation-added-dialog.component';

describe('CompensationAddedDialogComponent', () => {
  let component: CompensationAddedDialogComponent;
  let fixture: ComponentFixture<CompensationAddedDialogComponent>;

  describe('with configureModal spied (unit tests)', () => {
    beforeEach(async () => {
      await TestBed.configureTestingModule({
        imports: [CompensationAddedDialogComponent, HttpClientTestingModule]
      })
      .compileComponents();

      fixture = TestBed.createComponent(CompensationAddedDialogComponent);
